...
PS1='\[\e]2;\h::$__pretty_pwd\a\e]1;$__tab_title\a\]\u:$__vcs_prefix\[${_normal}\]${__vcs_ref}\[${_bold}\]${__vcs_base_dir} ${__vcs_sub_dir} \>' #${__vcs_sub_dir}\[${_normal}\]\$>'
